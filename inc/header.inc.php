<?php 
$query="select * from cfc_info where id=1";
...
$str=<<<A
					<a href="member.php?id={$member_id}" target="_blank">您好！{$_COOKIE['cfc']['name']}</a> <span style="color:#fff;">|</span> <a href="logout.php">退出</a>
A;
					echo $str;		
				}else{
$str=<<<A
