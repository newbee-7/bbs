...
<div id="main">
	...
	<table class="list">
		...
		<?php 
		$query="select ssm.id,ssm.sort,ssm.module_name,sfm.module_name father_module_name,ssm.member_id from cfc_son_module ssm,cfc_father_module sfm where ssm.father_module_id=sfm.id order by sfm.id";
