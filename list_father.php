...
$query="select count(*) from cfc_content where module_id in({$id_son})";
$count_all=num($link,$query);
$query="select count(*) from cfc_content where module_id in({$id_son}) and time>CURDATE()";
...
<div id="main" class="auto">
	<div id="left">
		...
		<ul class="postsList">
			<?php 
			$query="select 
cfc_content.title,cfc_content.id,cfc_content.time,cfc_content.times,cfc_content.member_id,cfc_member.name,cfc_member.photo,cfc_son_module.module_name,cfc_son_module.id ssm_id 
from cfc_content,cfc_member,cfc_son_module where 
cfc_content.module_id in({$id_son}) and 
cfc_content.member_id=cfc_member.id and 
cfc_content.module_id=cfc_son_module.id {$page['limit']}";
