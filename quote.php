...
$query="select cfc_reply.content,cfc_member.name from cfc_reply,cfc_member where cfc_reply.id={$_GET['reply_id']} and cfc_reply.content_id={$_GET['id']} and cfc_reply.member_id=cfc_member.id";
...
if(isset($_POST['submit'])){
	...
	$query="insert into cfc_reply(content_id,quote_id,content,time,member_id) 
			values(
...
$query="select count(*) from cfc_reply where content_id={$_GET['id']} and id<={$_GET['reply_id']}";
